    ...
    const getStoreCustomizationData = async () => {
      try {
        ...
        if (res) {
          ...
          setValue("help_text", res?.navbar?.help_text[language || "es"]);

          setValue("categories", res?.navbar?.categories[language || "es"]);
          setValue("about_us", res?.navbar?.about_us[language || "es"]);
          setValue("contact_us", res?.navbar?.contact_us[language || "es"]);
          setValue("offers", res?.navbar?.offers[language || "es"]);
          setValue("faq", res?.navbar?.faq[language || "es"]);
          setValue(
            "privacy_policy",
            res?.navbar?.privacy_policy[language || "es"]
          );
          setValue(
            "term_and_condition",
            res?.navbar?.term_and_condition[language || "es"]
          );

          setValue("pages", res?.navbar?.pages[language || "es"]);
          setValue("my_account", res?.navbar?.my_account[language || "es"]);
          setValue("login", res?.navbar?.login[language || "es"]);
          setValue("logout", res?.navbar?.logout[language || "es"]);
          setValue("checkout", res?.navbar?.checkout[language || "es"]);
          ...
          setValue(
            "discount_title",
            res?.home?.discount_title[language || "es"]
          );
          setValue(
            "promotion_title",
            res?.home?.promotion_title[language || "es"]
          );
          setValue(
            "promotion_description",
            res?.home?.promotion_description[language || "es"]
          );
          setValue(
            "promotion_button_name",
            res?.home?.promotion_button_name[language || "es"]
          );
          setValue("promotion_button_link", res?.home?.promotion_button_link);
          setValue("feature_title", res?.home?.feature_title[language || "es"]);
          setValue(
            "feature_description",
            res?.home?.feature_description[language || "es"]
          );
          setValue("feature_product_limit", res?.home?.feature_product_limit);
          setValue("popular_title", res?.home?.popular_title[language || "es"]);
          setValue(
            "popular_description",
          ...
          setValue(
            ...
            res?.home?.latest_discount_description[language || "es"]
          );
          setValue(
          ...
          setValue(
            "daily_need_title",
            res?.home?.daily_need_title[language || "es"]
          );
          setValue(
            "daily_need_description",
            res?.home?.daily_need_description[language || "es"]
          );
          ...
          setValue("slider_title", res?.slider?.first_title[language || "es"]);
          setValue(
            "slider_description",
            res?.slider?.first_description[language || "es"]
          );
          setValue(
            "slider_button_name",
            res?.slider?.first_button[language || "es"]
          );
          setValue("slider_button_link", res?.slider?.first_link);
          setValue(
            "slider_title_two",
            res?.slider?.second_title[language || "es"]
          );
          setValue(
            "slider_description_two",
            res?.slider?.second_description[language || "es"]
          );
          setValue(
            "slider_button_name_two",
            res?.slider?.second_button[language || "es"]
          );
          setValue("slider_button_link_two", res?.slider?.second_link);
          setValue(
            "slider_title_three",
            res?.slider?.third_title[language || "es"]
          );
          setValue(
            "slider_description_three",
            res?.slider?.third_description[language || "es"]
          );
          setValue(
            "slider_button_name_three",
            res?.slider?.third_button[language || "es"]
          );
          setValue("slider_button_link_three", res?.slider?.third_link);
          setValue(
            "slider_title_four",
            res?.slider?.four_title[language || "es"]
          );
          setValue(
            "slider_description_four",
            res?.slider?.four_description[language || "es"]
          );
          setValue(
            "slider_button_name_four",
            res?.slider?.four_button[language || "es"]
          );
          setValue("slider_button_link_four", res?.slider?.four_link);
          setValue(
            "slider_title_five",
            res?.slider?.five_title[language || "es"]
          );
          setValue(
            "slider_description_five",
            res?.slider?.five_description[language || "es"]
          );
          setValue(
            "slider_button_name_five",
            res?.slider?.five_button[language || "es"]
          );
          ...
          setValue(
            "personal_details",
            res?.checkout?.personal_details[language || "es"]
          );
          setValue("first_name", res?.checkout?.first_name[language || "es"]);
          setValue("last_name", res?.checkout?.last_name[language || "es"]);
          setValue(
            "email_address",
            res?.checkout?.email_address[language || "es"]
          );
          setValue(
            "checkout_phone",
            res?.checkout?.checkout_phone[language || "es"]
          );
          setValue(
            "shipping_details",
            res?.checkout?.shipping_details[language || "es"]
          );
          setValue(
            "street_address",
            res?.checkout?.street_address[language || "es"]
          );
          setValue("city", res?.checkout?.city[language || "es"]);
          setValue("country", res?.checkout?.country[language || "es"]);
          setValue("zip_code", res?.checkout?.zip_code[language || "es"]);
          setValue(
            "shipping_cost",
            res?.checkout?.shipping_cost[language || "es"]
          );
          setValue(
            "shipping_name_one",
            res?.checkout?.shipping_name_one[language || "es"]
          );
          setValue(
            "shipping_one_desc",
            res?.checkout?.shipping_one_desc[language || "es"]
          );
          setValue("shipping_one_cost", res?.checkout?.shipping_one_cost);
          setValue(
            "shipping_name_two",
            res?.checkout?.shipping_name_two[language || "es"]
          );
          setValue(
            "shipping_two_desc",
            res?.checkout?.shipping_two_desc[language || "es"]
          );
          setValue("shipping_two_cost", res?.checkout?.shipping_two_cost);
          setValue(
            "payment_method",
            res?.checkout?.payment_method[language || "es"]
          );
          setValue(
            "continue_button",
            res?.checkout?.continue_button[language || "es"]
          );
          setValue(
            "confirm_button",
            res?.checkout?.confirm_button[language || "es"]
          );
          setValue(
            "order_summary",
            res?.checkout?.order_summary[language || "es"]
          );
          setValue(
            "apply_button",
            res?.checkout?.apply_button[language || "es"]
          );
          setValue("sub_total", res?.checkout?.sub_total[language || "es"]);
          setValue("discount", res?.checkout?.discount[language || "es"]);
          setValue("total_cost", res?.checkout?.total_cost[language || "es"]);

          //dashboard
          setValue(
            "invoice_message_first",
            res?.dashboard?.invoice_message_first[language || "es"]
          );
          setValue(
            "invoice_message_last",
            res?.dashboard?.invoice_message_last[language || "es"]
          );
          setValue(
            "print_button",
            res?.dashboard?.print_button[language || "es"]
          );
          setValue(
            "download_button",
            res?.dashboard?.download_button[language || "es"]
          );
          setValue(
            "dashboard_title",
            res?.dashboard?.dashboard_title[language || "es"]
          );
          setValue(
            "total_order",
            res?.dashboard?.total_order[language || "es"]
          );
          setValue(
            "pending_order",
            res?.dashboard?.pending_order[language || "es"]
          );
          setValue(
            "processing_order",
            res?.dashboard?.processing_order[language || "es"]
          );
          setValue(
            "complete_order",
            res?.dashboard?.complete_order[language || "es"]
          );
          setValue(
            "recent_order",
            res?.dashboard?.recent_order[language || "es"]
          );
          setValue("my_order", res?.dashboard?.my_order[language || "es"]);
          setValue(
            "update_profile",
            res?.dashboard?.update_profile[language || "es"]
          );
          setValue("full_name", res?.dashboard?.full_name[language || "es"]);
          setValue("address", res?.dashboard?.address[language || "es"]);
          setValue("user_phone", res?.dashboard?.user_phone[language || "es"]);
          setValue("user_email", res?.dashboard?.user_email[language || "es"]);
          setValue(
            "update_button",
            res?.dashboard?.update_button[language || "es"]
          );
          setValue(
            "current_password",
            res?.dashboard?.current_password[language || "es"]
          );
          setValue(
            "new_password",
            res?.dashboard?.new_password[language || "es"]
          );
          setValue(
            "change_password",
            res?.dashboard?.change_password[language || "es"]
          );
          ...
          setValue(
            "promo_free_shipping",
            res?.footer?.shipping_card[language || "es"]
          );
          setValue(
            "promo_support",
            res?.footer?.support_card[language || "es"]
          );
          setValue(
            "promo_payment",
            res?.footer?.payment_card[language || "es"]
          );
          setValue("promo_offer", res?.footer?.offer_card[language || "es"]);
          setValue(
            "footer_block_one_title",
            res?.footer?.block1_title[language || "es"]
          );
          ...
          setValue(
            ...
            res?.footer?.block1_sub_title1[language || "es"]
          );
          setValue(
            "footer_block_one_link_two_title",
            res?.footer?.block1_sub_title2[language || "es"]
          );
          setValue(
            "footer_block_one_link_three_title",
            res?.footer?.block1_sub_title3[language || "es"]
          );
          setValue(
            "footer_block_one_link_four_title",
            res?.footer?.block1_sub_title4[language || "es"]
          );

          setValue(
            "footer_block_two_title",
            res?.footer?.block2_title[language || "es"]
          );
          ...
          setValue(
            ...
            res?.footer?.block2_sub_title1[language || "es"]
          );
          setValue(
            "footer_block_two_link_two_title",
            res?.footer?.block2_sub_title2[language || "es"]
          );
          setValue(
            "footer_block_two_link_three_title",
            res?.footer?.block2_sub_title3[language || "es"]
          );
          setValue(
            "footer_block_two_link_four_title",
            res?.footer?.block2_sub_title4[language || "es"]
          );

          setValue(
            "footer_block_three_title",
            res?.footer?.block3_title[language || "es"]
          );
          setValue(
          ...
          setValue(
            ...
            res?.footer?.block3_sub_title1[language || "es"]
          );
          setValue(
            "footer_block_three_link_two_title",
            res?.footer?.block3_sub_title2[language || "es"]
          );
          setValue(
            "footer_block_three_link_three_title",
            res?.footer?.block3_sub_title3[language || "es"]
          );
          setValue(
            "footer_block_three_link_four_title",
            res?.footer?.block3_sub_title4[language || "es"]
          );

          setValue(
            "footer_block_four_address",
            res?.footer?.block4_address[language || "es"]
          );
          ...
          setValue(
            ...
            res?.slug?.card_description_one[language || "es"]
          );
          ...
          setValue(
            ...
            res?.slug?.card_description_two[language || "es"]
          );
          ...
          setValue(
            ...
            res?.slug?.card_description_three[language || "es"]
          );
          ...
          setValue(
            ...
            res?.slug?.card_description_four[language || "es"]
          );
          ...
          setValue(
            ...
            res?.slug?.card_description_five[language || "es"]
          );
          ...
          setValue(
            ...
            res?.slug?.card_description_six[language || "es"]
          );
          ...
          setValue(
            ...
            res?.slug?.card_description_seven[language || "es"]
          );
          ...
          setValue("about_page_title", res?.about_us?.title[language || "es"]);
          setValue(
            "about_page_Top_title",
            res?.about_us?.top_title[language || "es"]
          );
          setValue(
            "about_us_top_description",
            res?.about_us?.top_description[language || "es"]
          );
          setValue(
            "about_page_Top_left_box_one_title",
            res?.about_us?.card_one_title[language || "es"]
          );
          setValue(
            "about_page_Top_left_box_one_subtitle",
            res?.about_us?.card_one_sub[language || "es"]
          );
          setValue(
            "about_us_top_box_one_description",
            res?.about_us?.card_one_description[language || "es"]
          );
          setValue(
            "about_page_Top_left_box_two_title",
            res?.about_us?.card_two_title[language || "es"]
          );
          setValue(
            "about_page_Top_left_box_two_subtitle",
            res?.about_us?.card_two_sub[language || "es"]
          );
          setValue(
            "about_us_top_box_two_description",
            res?.about_us?.card_two_description[language || "es"]
          );
          setValue(
            "about_us_middle_description_one",
            res?.about_us?.middle_description_one[language || "es"]
          );
          setValue(
            "about_us_middle_description_two",
            res?.about_us?.middle_description_two[language || "es"]
          );
          setValue(
            "about_page_ourfounder_title",
            res?.about_us?.founder_title[language || "es"]
          );
          setValue(
            "about_us_ourfounder_description",
            res?.about_us?.founder_description[language || "es"]
          );
          setValue(
            "about_page_ourfounder_one_title",
            res?.about_us?.founder_one_name[language || "es"]
          );
          setValue(
            "about_page_ourfounder_one_sub_title",
            res?.about_us?.founder_one_sub[language || "es"]
          );
          setValue(
            "about_page_ourfounder_two_title",
            res?.about_us?.founder_two_name[language || "es"]
          );
          setValue(
            "about_page_ourfounder_two_sub_title",
            res?.about_us?.founder_two_sub[language || "es"]
          );
          setValue(
            "about_page_ourfounder_three_title",
            res?.about_us?.founder_three_name[language || "es"]
          );
          setValue(
            "about_page_ourfounder_three_sub_title",
            res?.about_us?.founder_three_sub[language || "es"]
          );
          setValue(
            "about_page_ourfounder_four_title",
            res?.about_us?.founder_four_name[language || "es"]
          );
          setValue(
            "about_page_ourfounder_four_sub_title",
            res?.about_us?.founder_four_sub[language || "es"]
          );
          setValue(
            "about_page_ourfounder_five_title",
            res?.about_us?.founder_five_name[language || "es"]
          );
          setValue(
            "about_page_ourfounder_five_sub_title",
            res?.about_us?.founder_five_sub[language || "es"]
          );
          setValue(
            "about_page_ourfounder_six_title",
            res?.about_us?.founder_six_name[language || "es"]
          );
          setValue(
            "about_page_ourfounder_six_sub_title",
            res?.about_us?.founder_six_sub[language || "es"]
          );
          ...
          setValue(
            "contact_page_title",
            res?.contact_us?.title[language || "es"]
          );
          setValue(
            "email_box_title",
            res?.contact_us?.email_box_title[language || "es"]
          );
          setValue(
            "email_box_email",
            res?.contact_us?.email_box_email[language || "es"]
          );
          setValue(
            "email_box_text",
            res?.contact_us?.email_box_text[language || "es"]
          );
          setValue(
            "callUs_box_title",
            res?.contact_us?.call_box_title[language || "es"]
          );
          setValue(
            "callUs_box_phone",
            res?.contact_us?.call_box_phone[language || "es"]
          );
          setValue(
            "callUs_box_text",
            res?.contact_us?.call_box_text[language || "es"]
          );
          setValue(
            "address_box_title",
            res?.contact_us?.address_box_title[language || "es"]
          );
          setValue(
            "address_box_address_one",
            res?.contact_us?.address_box_address_one[language || "es"]
          );
          setValue(
            "address_box_address_two",
            res?.contact_us?.address_box_address_two[language || "es"]
          );
          setValue(
            "address_box_address_three",
            res?.contact_us?.address_box_address_three[language || "es"]
          );
          setValue(
            "contact_form_title",
            res?.contact_us?.form_title[language || "es"]
          );
          setValue(
            "contact_form_description",
            res?.contact_us?.form_description[language || "es"]
          );
          ...
          setValue(
            "privacy_page_title",
            res?.privacy_policy?.title[language || "es"]
          );
          ...
          setValue(
            ...
            res?.term_and_condition?.title[language || "es"]
          );
          ...
          setValue("faq_page_title", res?.faq?.title[language || "es"]);
          setValue("faq_title_one", res?.faq?.faq_one[language || "es"]);
          setValue(
            "faq_description_one",
            res?.faq?.description_one[language || "es"]
          );
          setValue("faq_title_two", res?.faq?.faq_two[language || "es"]);
          setValue(
            "faq_description_two",
            res?.faq?.description_two[language || "es"]
          );
          setValue("faq_title_three", res?.faq?.faq_three[language || "es"]);
          setValue(
            "faq_description_three",
            res?.faq?.description_three[language || "es"]
          );
          setValue("faq_title_four", res?.faq?.faq_four[language || "es"]);
          setValue(
            "faq_description_four",
            res?.faq?.description_four[language || "es"]
          );
          setValue("faq_title_five", res?.faq?.faq_five[language || "es"]);
          setValue(
            "faq_description_five",
            res?.faq?.description_five[language || "es"]
          );
          setValue("faq_title_six", res?.faq?.faq_six[language || "es"]);
          setValue(
            "faq_description_six",
            res?.faq?.description_six[language || "es"]
          );
          setValue("faq_title_seven", res?.faq?.faq_seven[language || "es"]);
          setValue(
            "faq_description_seven",
            res?.faq?.description_seven[language || "es"]
          );
          setValue("faq_title_eight", res?.faq?.faq_eight[language || "es"]);
          setValue(
            "faq_description_eight",
            res?.faq?.description_eight[language || "es"]
          );
          ...
          setValue("offers_page_title", res?.offers?.title[language || "es"]);
