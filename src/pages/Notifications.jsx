...
const Notifications = () => {
  ...
  return (
    <>
      ...
      <Card className="shadow-sm overflow-hidden bg-white dark:bg-gray-800 mb-5">
        <CardContent className="md:p-6 p-4 flex justify-between">
          <div className="">
            <Button
      ...
      <Card className="shadow-sm overflow-hidden bg-white dark:bg-gray-800 mb-5">
        <CardContent className="p-0">
          ...
          <div className="border rounded-md">
            <div className="bg-gray-200 border-gray-400 py-2 sm:px-6 px-4 dark:bg-gray-700 dark:text-gray-400 flex justify-between">
              <div className="flex">
                <CheckBox
                  type="checkbox"
                  name="selectAll"
            ...
            <div className="w-full lg:h-lg md:h-sm h-md relative md:p-6 p-2">
                        ...
                        return (
                          <TableRow className="border-none" key={index + 1}>
                            ...
                            >
                              ...
                              >
                                <Avatar className="mr-2 md:block bg-gray-50 border border-gray-200 h-8 w-8">
                                  <AvatarImage
                                    src={value.image}
                                    alt="notification"
                                  />
