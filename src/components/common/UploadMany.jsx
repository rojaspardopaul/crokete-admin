    ...
    <div className=" lg:flex md:flex flex-grow-0">
      <div className="flex gap-2">
          ...
          {(title === "Products" ||
            ...
            title === "Categories") && (
              ...
              >
                ...
                <FiUpload className="size-3 text-gray-400" />
        ...
        <div className="lg:flex-1 md:flex-1  sm:flex-none">
          ...
          >
            <FiDownload className="size-3 text-gray-400" />
      ...
      {isImportBoxShown && (
        <>
          <div className="w-full my-2 lg:my-0 md:my-0 flex">
            <div className="h-9 border border-dashed border-emerald-500 rounded-md">
              <label className="w-full rounded-lg h-9 flex justify-center items-center text-xs dark:text-gray-400 leading-none">
                <Input
                  disabled={isDisabled}
                  type="file"
                  accept=".csv,.xls,.json"
              ...
              {loading ? (
                <Button>
                  <img
                    ...
                    height={10}
                  />{" "}
                  <span className="font-serif ml-2 font-light">Procesando</span>
                </Button>
              ) : (
