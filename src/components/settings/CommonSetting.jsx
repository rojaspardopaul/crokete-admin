...
const CommonSetting = ({ errors, control, register, isSave, isSubmitting }) => {
        ...
        <div className="lg:px-6 pt-4 lg:pl-40 lg:pr-40 md:pl-5 md:pr-5 flex-grow scrollbar-hide w-full max-h-full pb-0">
          ...
          <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
            ...
            <div className="sm:col-span-3">
              ...
              >
                <SelectTrigger>
                  <SelectValue placeholder={t("DefaultDateFormat")} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="MMM D, YYYY">MM/DD/YYYY</SelectItem>
                  <SelectItem value="D MMM, YYYY">DD/MM/YYYY</SelectItem>
                  <SelectItem value="YYYY,MMM D">YYYY/MM/DD</SelectItem>
                </SelectContent>
              </Select>
